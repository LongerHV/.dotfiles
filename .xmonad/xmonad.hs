...
---CONFIG
------------------------------------------------------------------------
myFont          = "xft:Hack Nerd Font:regular:pixelsize=14"
myModMask       = mod4Mask  -- Sets modkey to super/windows key
myTerminal      = "alacritty"      -- Sets default terminal
myTextEditor    = "vom"     -- Sets default text editor
...
myKeys =
    ...
    --- Dmenu Scripts (Alt+Ctr+Key)
        , ("M-S-<Return>", spawn "dmenu_run -fn 'Hack Nerd Font:size=14' -nb '#073642' -nf '#859900' -sb '#859900' -sf '#073642' -p 'dmenu:'")
